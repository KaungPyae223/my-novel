...
import { useCreateNovelPost } from "@/services/post";
...
const PostCreate = ({ novelId }: { novelId: string }) => {
  ...
  const { mutate } = useCreateNovelPost({ novelId });

  // 2. Define a submit handler.
  function onSubmit(values: z.infer<typeof formSchema>) {
    toast.loading("Creating a post...");
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <DialogHeader>
            ...
            <DialogDescription>
              Write something about your novel
            </DialogDescription>
          </DialogHeader>
